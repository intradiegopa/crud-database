<?php
    ...
    // e il browser verrà reindirizzato alla pagina corretta per il tipo di utente
    ...
    { 
      ...
      elseif( !isset($_POST['password']) || $_POST['password'] ==""){
        $error="Attenzione! Inserire la password.";
            ...
            $auth = $db->session("SELECT * FROM utenti WHERE username = '$username' AND password = '$password'");
            ...
            $error="Username  o Password errata!";
                  ...
                  $_SESSION['auth'] = $auth["username"];
                  $_SESSION['id_auth'] = $auth["id"];
